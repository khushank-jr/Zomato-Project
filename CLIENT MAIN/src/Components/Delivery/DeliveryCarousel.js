...
const DeliveryCarousel = () => {
    ...
    return (
        <>
            <h1 className='text-xl md:text-2xl md:text-3xl mb-4 font-semibold'>Inspiration for your first order</h1>

            <div className='lg:hidden flex gap-3 md:gap-6 lg:gap-0 flex-wrap justify-between'>
